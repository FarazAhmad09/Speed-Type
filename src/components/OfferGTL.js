...
export default function OfferGTL() {
            ...
            <section className="py-2 mt-5">
                <div className="max-w-screen-xl mx-auto px-4  gap-x-12 justify-between md:flex md:px-8">
                    <div className="max-w-xxl">
                        <h3 className="text-gray-600 text-3xl font-bold sm:text-3xl pb-5">
                            General Trading LLC (Main-Land)
                        </h3>
                        <h3 className="text-gray-500 text-1xl font-bold sm:text-1xl pb-1">
                            Inclusions
                        </h3>
                        ...
                        <div className="mt-2 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <p className="ml-2">Payment voucher covered up to AED 27,000</p>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FFD700" className="bi bi-check" viewBox="0 0 16 16" id="IconChangeColor">
                                    <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" id="mainIconPathAttribute"></path>
                        ...
                        <p className="mt-5 text-gray-500 font-small" style={{ lineHeight: 2 }}>
                            A General Trading License specifically allows the holder of the Business License to trade in
                            various items, such as would be the case with a spices store or a supermarket. However, this
                            comes with its own set of restrictions on what you may trade in and what you may not. For
                            example, alcoholic beverages, firearms, and medical / healthcare products cannot be sold
                            without securing additional permits. Dealing with frozen foods and perishable vegetables
                            too comes with its own set of restrictions – you must have a temperature- controlled storage
                            area or godown apart from the retail area.
