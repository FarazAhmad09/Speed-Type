...
export default function Technology() {
    return (
        <>
            ...
            <div className='bg-white technology-bg-img'>
                    ...
                    <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
                        <div className="max-w-xl space-y-3 md:mx-auto">
                            <ScrollAnimation animateIn="fadeIn">
                                <h3 className="text-white text-3xl font-bold sm:text-4xl mb-2">
                                    Technology
                                </h3>
                                <p className="text-white">
                                    Technology companies in the UAE can be categorized into various sectors based on their areas
                                    of specialization and the services they provide. Here are some common categories
                                </p>
                            </ScrollAnimation>
                        </div>
                    </div>
                        ...
                        <div className="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
                            <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                                <ScrollAnimation animateIn="fadeInLeft">
                                    <h3 className="text-gray-600 text-3xl font-bold sm:text-2xl">
                                        Software   <span style={{ color: "#eab308" }}>Development :</span>
                                    </h3>
                                    <p className="mt-3  text-gray-500 font-medium">
                                        Software development companies are at the forefront of innovation, crafting diverse solutions ranging from mobile
                                        apps and web applications to enterprise software and SaaS products. With dedicated teams of skilled professionals,
                                        they conceptualize, design, develop, and deploy custom solutions to address specific client requirements.
                                        These companies play a pivotal role in driving digital transformation and empowering businesses to thrive in an increasingly
                                        competitive landscape. Through their expertise and commitment to excellence, they enable organizations to streamline operations,
                            ...
                            <div className="flex-1 sm:hidden lg:block">
                                <ScrollAnimation animateIn="fadeInRight">
                                    <img src={technology_img} className="md:max-w-lg sm:rounded-lg" alt="Technology-img" />
                                </ScrollAnimation>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-xxl">
                            <ScrollAnimation animateIn="fadeIn">
                                <h3 className="text-gray-600 text-3xl font-bold sm:text-2xl pb-1">
                                    <span style={{ color: "#eab308" }}> Telecommunications :</span>
                                </h3>
                            </ScrollAnimation>
                            <p className="mt-5 text-gray-500 font-medium">
                                Telecom companies providing internet, mobile, and
                                landline services, as well as infrastructure development for telecommunications
                                networks.
                            </p>
                            ...
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Firms offering IT consulting, system integration, network infrastructure setup, cybersecurity services, and IT support.
                            </p>
                            <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                E-commerce and Online Marketplaces :
                            </h3>
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Companies operating online retail platforms, marketplaces, and e-commerce solutions, facilitating online buying and selling.
                            </p>
                            <ScrollAnimation animateIn="fadeIn">
                                <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                    Hardware <span style={{ color: "#eab308" }}> Manufacturing :</span>
                                </h3>
                            </ScrollAnimation>
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                This is where we come into the picture. At Speed Type, we have a track record of matching companies with the right Local Partner. Our business setup experts are all informed of the latest changes in legislation and can tell you that if you are a professional planning to offer professional services*, then what you need is a Local Service Agent and not a Local Partner.
                            </p>
                            <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                Fintech :
                            </h3>
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Financial technology companies focusing on digital payment solutions,
                                blockchain technology, peer-to-peer lending, crowdfunding platforms, and other
                            ...
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Companies specializing in healthcare technology, including
                                electronic health records (EHR), telemedicine platforms, medical device
                                manufacturing, and health analytics.
                            </p>
                            <ScrollAnimation animateIn="fadeIn">
                                <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                    Artificial Intelligence  <span style={{ color: "#eab308" }}>and Machine Learning : </span>
                                </h3>
                            </ScrollAnimation>
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Organizations developing AI and
                                ML algorithms, applications, and platforms for various industries such as finance,
                            ...
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                ...
                                implementing renewable energy solutions, including solar power, wind energy,
                            ...
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Emerging sector focusing on satellite technology, space
                                exploration, satellite communication, and satellite imagery analysis.
                            </p>
                            <ScrollAnimation animateIn="fadeIn">
                                <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                    Robotics and <span style={{ color: "#eab308" }}>Automation : </span>
                                </h3>
                            </ScrollAnimation>
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Companies involved in developing robotics solutions
                                for industrial automation, logistics, manufacturing, and service sectors.
                            </p>
                            <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                Cybersecurity :
                            </h3>
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Specialized firms offering cybersecurity solutions, including threat
                                detection, vulnerability assessments, penetration testing, and security consulting
                                services.
                            </p>
                            <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                Edtech :
                            ...
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Companies providing educational technology solutions, including elearning platforms, online courses, virtual classrooms, and educational software.
                            </p>
                            <ScrollAnimation animateIn="fadeIn">
                                <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                                    <span style={{ color: "#eab308" }}>Agritech :</span>
                                </h3>
                            </ScrollAnimation>
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Tech companies focusing on agricultural technology, including
                                precision farming, crop monitoring, agricultural drones, and farm management
                                software.
                            </p>
                            <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5">
                            ...
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Entities working on blockchain technology,
                                cryptocurrency exchanges, digital asset management, and blockchain-based
                                applications.
                            </p>
                            <h3 className=" text-gray-600 text-3xl font-bold sm:text-2xl mt-5 ">
                            ...
                            <p className="mt-5 text-gray-500 font-medium" style={{ lineHeight: 2 }}>
                                Companies developing AR and VR solutions
                                for gaming, entertainment, education, training, and enterprise applications.
                            </p>
                            <h3 className="mt-5 text-gray-500 text-1xl font-bold sm:text-1xl mb-5" style={{ lineHeight: 2, fontSize: 20 }}>
                                These categories represent the diverse range of technology companies operating in the
                                UAE, contributing to the country's technological advancement and economic growth.
                            </h3>
                        </div>
                    </div>
                </section>
